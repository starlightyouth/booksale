...
public class ModifyBookInterface extends JFrame {
    ...
    private final JLabel LabelId = new JLabel("请输入待修改图书的编号：");
    private final JLabel LabelId_1 = new JLabel("图书编号：");
    private final JTextField textField = new JTextField();
    private final JButton ButtonConfim = new JButton("确认");
    private final JLabel LabelMessage = new JLabel("请输入修改后的图书信息：");
    ...
    private final JLabel LabelPirce = new JLabel("图书价格：");
    private final JTextField textField_4 = new JTextField();
    private final JButton ButtonModify = new JButton("确认修改");
    private final JLabel LabelWarn = new JLabel("警告：操作无法撤销，请仔细确认后修改！");
    private final JButton ButtonDel = new JButton("重置输入");
    ...
    public ModifyBookInterface() {
        ...
        this.ButtonConfim.setBounds(307, 63, 90, 30);
        ...
        this.LabelPirce.setBounds(35, 262, 60, 18);

        contentPane.add(this.LabelPirce);
        ...
        this.ButtonModify.setBounds(73, 356, 90, 30);
        this.ButtonModify.setEnabled(false);// 未载入书籍的状态下确认修改按钮不可用
        contentPane.add(this.ButtonModify);
        this.LabelWarn.setFont(new Font("SansSerif", Font.BOLD, 18));
        this.LabelWarn.setBounds(35, 300, 353, 26);
        ...
        this.ButtonDel.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                ButtonModify.setEnabled(false);// 使得确认修改按钮不可用
            }
        });
        this.ButtonDel.setBounds(251, 356, 90, 30);
    ...
    private void Loadbook() {
        ...
        try {
            ...
            if (!rs.next()) {
                ...
                ButtonModify.setEnabled(true);// 使确认修改按钮可用
