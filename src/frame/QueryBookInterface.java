...
public class QueryBookInterface extends JFrame {
    ...
    private final JLabel LabelMoHu = new JLabel("模糊查询：");
    ...
    private final JLabel LabelZhi = new JLabel("至");
    private final JTextField textField_4 = new JTextField();
    private final JButton ButtonQuery = new JButton("查询");
    private final JLabel label_4 = new JLabel("");
    private final JLabel Label_5 = new JLabel("精确查询：");
    private final JLabel label_2_2 = new JLabel("图书编号：");
    private final JTextField textField_5 = new JTextField();
    private final JButton ButtonQuery_1 = new JButton("查询");
    ...
    public QueryBookInterface() {
        ...
        this.LabelMoHu.setFont(new Font("SansSerif", Font.BOLD, 18));
        this.LabelMoHu.setBounds(18, 16, 93, 26);

        contentPane.add(this.LabelMoHu);
        ...
        this.LabelZhi.setBounds(171, 191, 55, 18);

        contentPane.add(this.LabelZhi);
        ...
        this.ButtonQuery.setBounds(95, 239, 110, 43);
        ...
        this.Label_5.setFont(new Font("SansSerif", Font.BOLD, 18));
        this.Label_5.setBounds(18, 337, 93, 26);
        ...
        this.ButtonQuery_1.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                Precisequery();
            }
        });
        this.ButtonQuery_1.setBounds(95, 413, 110, 43);

        contentPane.add(this.ButtonQuery_1);
