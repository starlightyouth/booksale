...
public class Connect {
    ...
    // 数据库URL
    static final String jdbcUrl = "jdbc:mysql://localhost/book1?useSSL=false&characterEncoding=utf8&allowPublicKeyRetrieval=true&serverTimezone=UTC";
    static final String jdbcUsername = "root"; // 数据库账户名
    static final String jdbcPassword = "xulekai520"; // 数据库账户名的密码
     ...
     * @throws Exception
     */
    public void closeCon(Connection con) throws Exception {// 关闭数据库
        if (con != null) {
            con.close();
        }
    }
